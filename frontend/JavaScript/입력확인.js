...
// 삼항연산자 : 항 3개인 연산자, 참과 거짓만 있는 조건문을 대체할 수 있음
let age = parseInt(prompt("나이 입력 : " ), 10)
console.log(`당신의 나이는 ${age}살이고, ${age > 19 ? '성인' : '미성년'}입니다.`);
...
// 형변환 : 묵시적형변환 명시적형변환 : 자바스크립트는 값이 대입 될 때 형이 결정 됨으로 묵시적, 명시적 형변환 필요 없음
const kor = 66;
const eng = 33;
const mat = 99;

const avg = (kor + eng + mat) / 3
